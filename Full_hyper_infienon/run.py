...
from pipelines.training_model import Training_model_pipeline_Gesture
import argparse
...
#         raise click.BadParameter("n_estimators_rf must be an integer or a float.")
#     return value
def validate_for_int_and_float(ctx, param, value):
    try:
...
@click.option(
    ...
    type=int,
    default=2500,
    help="Specify the limit number. Default is 1000.",
)
...
#     type=str,
#     default='log_loss',
#     help="Specify the loss function for Gradient Boosting. Default is 'log_loss'."
# )
...
def main(
    ...
    print(f'config= {config}, test_size= {test_size}, select_model= {select_model}, table_name= {table_name}, limit_num= {limit_num}, max_depth_dtc= {max_depth_dtc}, max_depth_rf= {max_depth_rf}, n_estimators_rf= {n_estimators_rf}, max_depth_gb= {max_depth_gb}, learning_rate= {learning_rate}, criterion= {criterion}')
...
## python run.py --test_size 0.2 --select_model Decision_Tree --table_name infineon_gesture --limit_num 25000 --n_estimators_rf 100 --max_depth_rf 1 --max_depth_gb 3 --learning_rate 0.1 --max_depth_dtc None --criterion gini
