...
# Replace the entire contents of the target ZenML BentoML model deployer Python file
ZENML_FILE__init__="/opt/venv/lib64/python3.11/site-packages/zenml/integrations/bentoml/services/__init__.py"

cat > "$ZENML_FILE__init__" << 'EOF'
"""Initialization for BentoML services as version 0.63.0 ."""
...
EOF
echo "✅ Completed overwriting of file: $ZENML_FILE__init__"

# Define the directory and target file path
SERVICES_PATH="/opt/venv/lib64/python3.11/site-packages/zenml/integrations/bentoml/services"
BENTOML_DEPLOYMENT_FILE="$SERVICES_PATH/bentoml_deployment.py"      

# Make sure the directory exists (create it if it doesn't)
mkdir -p "$SERVICES_PATH"

# Create the file with your custom Python code
cat > "$BENTOML_DEPLOYMENT_FILE" << 'EOF'
...
echo "✅ Completed creation and overwriting of file: $BENTOML_DEPLOYMENT_FILE"
